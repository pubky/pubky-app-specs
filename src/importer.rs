...
mod tests {
    ...
    fn test_import_user() {
        ...
        let result = import_object(uri, user_json.as_bytes());
        assert!(
            result.is_ok(),
    ...
    fn test_import_post() {
        ...
        let result = import_object(uri, post_json.as_bytes());
        assert!(
            result.is_ok(),
    ...
    fn test_import_follow() {
        ...
        let result = import_object(uri, follow_json.as_bytes());
        assert!(
            result.is_ok(),
    ...
    fn test_import_mute() {
        ...
        let result = import_object(uri, mute_json.as_bytes());
        assert!(
            result.is_ok(),
    ...
    fn test_import_bookmark() {
        ...
        let result = import_object(uri, bookmark_json.as_bytes());
        assert!(
            result.is_ok(),
    ...
    fn test_import_tag() {
        ...
        let result = import_object(uri, tag_json.as_bytes());
        assert!(
            result.is_ok(),
    ...
    fn test_import_file() {
        ...
        let result = import_object(uri, file_json.as_bytes());
        assert!(
            result.is_ok(),
    ...
    fn test_import_blob() {
        ...
        let result = import_object(uri, blob_json.as_bytes());
        assert!(
            result.is_ok(),
    ...
    fn test_import_feed() {
        ...
        let result = import_object(uri, feed_json.as_bytes());
        assert!(
            result.is_ok(),
    ...
    fn test_import_last_read() {
        ...
        let result = import_object(uri, last_read_json.as_bytes());
        assert!(
            result.is_ok(),
    ...
    fn test_import_unknown_resource() {
        ...
        let json = r#"{}"#;
        let result = import_object(uri, json.as_bytes());
        assert!(
            result.is_err(),
